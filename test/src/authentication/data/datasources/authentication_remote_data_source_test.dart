...
void main() {
  ...
  group('getUsers', () {
    ...
    test('should return [APIException] when the status code is not 200',
        () async {
      const tMessage =
          'Server down, Server down I repeat Server down. Mayday Mayday Mayday, We are going down AHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH';
      when(() => client.get(any()))
